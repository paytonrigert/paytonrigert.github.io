                ...
                <div class="container overflow-hidden">
                    <div class="row gy-5 gy-md-6 gx-xl-6">
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            ...
                            <h5 class="m-2">Management Consulting</h5>
                        ...
                        <div class="col-12 col-sm-6 col-lg-4">
                            ...
                            <h5 class="m-2">Risk Communication</h5>
                            <p class="m-0 text-secondary">Risk communication is the process of exchanging information about potential hazards, risks, and uncertainties in a clear and effective manner. It involves providing individuals or communities with information that can help them make informed decisions about their health, safety, and well-being.</p>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="text-center">
                            ...
                            <h5 class="m-2">Emergency Response</h5>
                            <p class="m-0 text-secondary">Public health emergency response work involves the coordinated efforts of healthcare professionals, government agencies, non-governmental organizations, and community partners to prevent, prepare for, and respond to public health emergencies.</p>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="text-center">
                            ...
                            <h5 class="m-2">Disease Prevention and Control</h5>
                            <p class="m-0 text-secondary">Public health consultants can help develop strategies to prevent the spread of infectious diseases, such as COVID-19, through vaccination campaigns, contact tracing, and other measures.</p>
                            </div>
                        </div>
                        <div class="col-12 col-sm-6 col-lg-4">
                            <div class="text-center">
